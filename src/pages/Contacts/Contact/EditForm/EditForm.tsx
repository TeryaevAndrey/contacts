...
import { Form, CloseBtn, Title, FormBtn, NewContactStyle } from "../../NewContact/NewContact";
    ...
    return(
        <NewContactStyle>
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
                <InputStyle {...register('name')} defaultValue={name} placeholder="Новое имя" />
                <InputMask {...register('tel')} className="InputMask" defaultValue={tel} mask="+7 (999) 999-99-99" placeholder="Новые номер" />
